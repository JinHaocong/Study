import {addCart, decreaseCount, increaseCount} from '../../../store/modules/takeaway'
import './index.scss'
import {FC} from "react";
import {Food} from "../../../store/interface";
                    ...
                    <div className="goods-count">
                        {/* 添加商品 */}
                        {
                            count > 0 ?
                                <Count
                                    count={count}
                                    onPlus={() => dispatch(increaseCount({id}))}
                                    onMinus={() => dispatch(decreaseCount({id}))}
                                /> :
