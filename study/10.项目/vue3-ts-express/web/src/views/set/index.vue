<template>
  ...
  <!--              >-->
  <!--                <template #trigger>-->
  <!--                  <img v-if="imageUrl[index]" :src="imageUrl[index]" alt="轮播图" class="swiper" />-->
  ...
  <!--          <div class="other-set">-->
  <!--            <div-->
  <!--              v-if="userStore.identity !== '用户管理员' || userStore.identity !== '用户'"-->
  ...
  <!--            </div>-->
  <!--            <div-->
  <!--              v-if="userStore.identity == '超级管理员' || userStore.identity == '产品管理员'"-->
  <!--              class="product-set"-->
  <!--            >-->
  <!--              <span>产品设置</span>-->
  <!--              <el-tag-->
...
// import { bind, changeName, changeSex, changeEmail, getUserInfo } from '@/api/userInfo'
// import {
//   getCompanyName,
//   changeCompanyName,
//   getAllSwiper,
