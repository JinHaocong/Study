...
!(function (e, t) {
  ...
  (E.fn = E.prototype =
    {
      ...
      map(n) {
        return this.pushStack(E.map(this, (e, t) => n.call(e, t, e)));
      },
      slice() {
      ...
      even() {
        return this.pushStack(E.grep(this, (e, t) => (t + 1) % 2));
      },
      odd() {
        return this.pushStack(E.grep(this, (e, t) => t % 2));
      },
      eq(e) {
        const t = this.length;
        const n = +e + (e < 0 ? t : 0);
  ...
  const d = (function (n) {
            ...
            d.getById
              ? ((b.filter.ID = function (e) {
                ...
                (b.find.ID = function (e, t) {
                  if (typeof t.getElementById !== 'undefined' && S) {
            ...
            (d.qsa = K.test(C.querySelectorAll)) &&
              (ce((e) => {
                ...
                (a.appendChild(e).innerHTML =
                  `<a id='${E}'></a><select id='${E}-\r\\' msallowcapture=''><option selected=''></option></select>`),
    ...
    (se.attr = function (e, t) {
      ...
      let r = n && D.call(b.attrHandle, t.toLowerCase()) ? n(e, t, !S) : void 0;
      return void 0 !== r
        ? r
        : d.attributes || !S
          ? e.getAttribute(t)
          ...
          CHILD(h, e, t, g, y) {
            ...
            return g === 1 && y === 0
              ...
              : function (e, t, n) {
                  ...
                  let s;
                  let u;
                  let l = v !== m ? 'nextSibling' : 'previousSibling';
  ...
  function j(e, n, r) {
    return m(n)
      ? E.grep(e, (e, t) => !!n.call(e, t, e) !== r)
      : n.nodeType
        ? E.grep(e, (e) => (e === n) !== r)
        : typeof n !== 'string'
          ? E.grep(e, (e) => i.call(n, e) > -1 !== r)
          : E.filter(n, e, r);
  }
  (E.filter = function (e, t, n) {
    ...
    E.fn.extend({
      ...
      is(e) {
        return !!j(
          this,
          typeof e === 'string' && k.test(e) ? E(e) : e || [],
          !1
        ).length;
      },
    });
  ...
  const B = function (e, t, n, r, i, o, a) {
    ...
    const u = e.length;
    let l = n == null;
    if (w(n) === 'object') for (s in ((i = !0), n)) B(e, t, s, n[s], !0, o, a);
    else if (
      void 0 !== r &&
      ((i = !0),
      m(r) || (a = !0),
  ...
  function xe(e, t, n, r, i) {
    for (
      ...
      if ((o = e[d]) || o === 0)
        if (w(o) === 'object') E.merge(p, o.nodeType ? [o] : o);
        else if (me.test(o)) {
  ...
  function He(n, r, i, o) {
    ...
    const d = r[0];
    const h = m(d);
    if (h || (f > 1 && typeof d === 'string' && !v.checkClone && Ae.test(d)))
  ...
  function Oe(e, t, n) {
    for (var r, i = t ? E.filter(t, e) : e, o = 0; (r = i[o]) != null; o++)
      n || r.nodeType !== 1 || E.cleanData(ye(r)),
        r.parentNode &&
  ...
  E.extend({
    ...
    clone(e, t, n) {
      ...
      return (
        (a = ye(c, 'script')).length > 0 && ve(a, !f && ye(e, 'script')), c
      );
    },
    cleanData(e) {
    ...
    E.fn.extend({
      ...
      empty() {
        for (var e, t = 0; (e = this[t]) != null; t++)
          e.nodeType === 1 && (E.cleanData(ye(e, !1)), (e.textContent = ''));
        return this;
      },
      clone(e, t) {
        return (
  ...
  const We = new RegExp(ne.join('|'), 'i');
  const Fe = '[\\x20\\t\\r\\n\\f]';
  const $e = new RegExp(`^${Fe}+|((?:^|[^\\\\])(?:\\\\.)*)${Fe}+$`, 'g');
  function Be(e, t, n) {
    let r;
    let i;
    let o;
  ...
  const Ue = S.createElement('div').style;
  const Xe = {};
  function Ve(e) {
    const t = E.cssProps[e] || Xe[e];
    return (
      t ||
      (e in Ue
        ? e
      ...
      n === 'margin' && (u += E.css(e, n + ne[a], !0, i)),
        r
          ? (n === 'content' && (u -= E.css(e, `padding${ne[a]}`, !0, i)),
            n !== 'margin' && (u -= E.css(e, `border${ne[a]}Width`, !0, i)))
  ...
  E.extend({
    ...
    E.each(['height', 'width'], (e, u) => {
      E.cssHooks[u] = {
        ...
        set(e, t, n) {
          let r;
          const i = Me(e);
          const o = !v.scrollboxSize() && i.position === 'absolute';
    ...
    (E.cssHooks.marginLeft = _e(v.reliableMarginLeft, (e, t) => {
      if (t)
        return `${
          parseFloat(Be(e, 'marginLeft')) ||
          e.getBoundingClientRect().left -
            Ie(e, { marginLeft: 0 }, () => e.getBoundingClientRect().left)
        }px`;
    })),
      ...
      _default: {
        ...
        set(e) {
          E.fx.step[e.prop]
            ? E.fx.step[e.prop](e)
            : e.elem.nodeType !== 1 ||
                (!E.cssHooks[e.prop] && e.elem.style[Ve(e.prop)] == null)
              ? (e.elem[e.prop] = e.now)
  ...
  (E.Animation = E.extend(ft, {
      ...
      function (e, t, n) {
        ...
        if ((u = !E.isEmptyObject(t)) || !E.isEmptyObject(d))
          for (r in (f &&
            ...
            (l = y && y.display) == null && (l = Y.get(e, 'display')),
    ...
    (rt.type = 'radio'),
    (v.radioValue = rt.value === 't');
  let pt;
  const dt = E.expr.attrHandle;
  E.fn.extend({
    attr(e, t) {
      return B(this, E.attr, e, t, arguments.length > 1);
    },
    removeAttr(e) {
      return this.each(function () {
        E.removeAttr(this, e);
  ...
  E.fn.extend({
    prop(e, t) {
      return B(this, E.prop, e, t, arguments.length > 1);
    },
    removeProp(e) {
      return this.each(function () {
    ...
    E.fn.extend({
      addClass(t) {
        ...
        return m(t)
          ...
          : (e = mt(t)).length
            ? this.each(function () {
                if (
                  ((r = vt(this)), (n = this.nodeType === 1 && ` ${yt(r)} `))
                ) {
      ...
      hasClass(e) {
        ...
        t = ` ${e} `;
        while ((n = this[r++]))
          if (n.nodeType === 1 && ` ${yt(vt(n))} `.indexOf(t) > -1) return !0;
        return !1;
      },
    });
  const xt = /\r/g;
    ...
    trigger(e, t, n, r) {
      ...
      if (
        ...
        n.nodeType !== 3 &&
          ...
          ((e = e[E.expando]
            ? e
            : new E.Event(d, typeof e === 'object' && e)).isTrigger = r
            ? 2
            : 3),
          (e.namespace = h.join('.')),
  ...
  E.parseXML = function (e) {
    ...
    return (
      ...
      (t && !n) ||
        E.error(
          `Invalid XML: ${
            n ? E.map(n.childNodes, (e) => e.textContent).join('\n') : e
          }`
        ),
      t
    );
  ...
  function jt(n, e, r, i) {
    ...
    if (Array.isArray(e))
      E.each(e, (e, t) => {
        r || Et.test(n)
          ? i(n, t)
          : jt(`${n}[${typeof t === 'object' && t != null ? e : ''}]`, t, r, i);
      });
  ...
  (Wt.href = Tt.href),
    E.extend({
      ...
      ajax(e, t) {
        ...
        let i;
        let o;
        const y = E.ajaxSetup({}, t);
        const v = y.context || y;
        const m = y.context && (v.nodeType || v.jquery) ? E(v) : E.event;
        const x = E.Deferred();
        const b = E.Callbacks('once memory');
        let w = y.statusCode || {};
        const a = {};
        const s = {};
        let u = 'canceled';
        ...
        function l(e, t, n, r) {
          ...
          h ||
            ...
            !i &&
              E.inArray('script', y.dataTypes) > -1 &&
  ...
  (v.cors = !!zt && 'withCredentials' in zt),
    ...
    E.ajaxPrefilter('script', (e) => {
      void 0 === e.cache && (e.cache = !1), e.crossDomain && (e.type = 'GET');
    }),
    E.ajaxTransport('script', (n) => {
      let r;
      let i;
  ...
  E.ajaxSetup({
    jsonp: 'callback',
    jsonpCallback() {
      const e = Xt.pop() || `${E.expando}_${Ct.guid++}`;
      return (this[e] = !0), e;
    },
  }),
    E.ajaxPrefilter('json jsonp', (e, t, n) => {
      let r;
      let i;
      let o;
      const a =
    ...
    E.each({ scrollLeft: 'pageXOffset', scrollTop: 'pageYOffset' }, (t, i) => {
  ...
  (E.proxy = function (e, t) {
    ...
    (E.trim = function (e) {
      return e == null ? '' : `${e}`.replace(Gt, '$1');
    }),
    typeof define === 'function' && define.amd && define('jquery', [], () => E);
  const Yt = C.jQuery;
  const Qt = C.$;
  return (
    ...
    typeof e === 'undefined' && (C.jQuery = C.$ = E),
    E
  );
});
